		...
		<div class="container-fluid">
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td class="text-center"><h2>Rental Mobil Alohay </h2></td>
					</tr>
					<tr>
						<td class="text-center">Kedulan, Tirtomartani, Kec. Kalasan, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55571 </td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
		...
		<div class="container-fluid">
			...
			<table class="table table-borderless">
				<tbody>
					...
					<?php if ($result['nama_sopir'] != "") { ?>
					<tr>
						<td>Nama Sopir</td>
						<td>:</td>
						<td><?php echo $result['nama_sopir'];?></td>
					</tr>
					<?php } ?>
					<tr>
						<td>Tanggal Mulai</td>
